...
final class GalleriesViewController: UIViewController, UICollectionViewDelegateFlowLayout {
    private let output: GalleriesViewOutput
    ...
    init(output: GalleriesViewOutput) {
        self.output = output
...
extension GalleriesViewController: GalleriesViewInput {
    func reloadData() {
...
extension GalleriesViewController: MosaicLayoutDelegate {
    func collectionView(
...
extension GalleriesViewController: UISearchBarDelegate {
